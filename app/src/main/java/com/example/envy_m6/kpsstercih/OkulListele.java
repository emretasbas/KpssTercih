...
public class OkulListele extends Activity {
    Spinner sp;
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        setContentView(R.layout.activity_okullistele);

    }

    //önce şehri seçip, intent ile şehrin ilçelerine gidiyoruz.(sehrin_idi) intent nesnesi ile taşıyoruz.
    public void onResume()
    {
        ...
        if(sehir_liste.size()==0){
            ...
            sp = (Spinner) findViewById(R.id.spinOkulListele1);
            btnSec = (Button) findViewById(R.id.btnOLSec);
